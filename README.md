...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/clustergram-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=11512&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/clustergram-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `clustergram` can be installed with:

```
conda install clustergram
```

It is possible to list all of the versions of `clustergram` available on your platform with:
